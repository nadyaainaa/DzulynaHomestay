...
<script src="https://cdn.jsdelivr.net/npm/fullcalendar@6.1.8/index.global.min.js"></script>
        ...
        <section class="section-padding">
            <div class="container">
                <h3  class="wow fadeInUp mb-2" data-wow-delay=".2s"> DzuLyna Homestay 2 : Bagan Datuk</h3>
                    ...
                    <div class="modal-content">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value="DzuLyna Homestay 2 - Bagan Datuk" readonly>
                                        </div>
                                        <div class="mb-3">
                        ...
                        <div class="modal-footer">
                            <form id="confirmBookingForm" method="POST" action="{{ route('booking.store') }}">
                                ...
                                <input type="hidden" name="homestay" value="2">
