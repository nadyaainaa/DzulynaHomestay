...
<script src="https://cdn.jsdelivr.net/npm/fullcalendar@6.1.8/index.global.min.js"></script>
        ...
        <section class="section-padding">
            <div class="container">
                <h3  class="wow fadeInUp mb-2" data-wow-delay=".2s"> DzuLyna Homestay 1 : Teluk Intan</h3>
                <p class="text-muted fw-bold fs-5 wow fadeInUp" data-wow-delay=".2s">RM120 / night</p>
                <!-- ✅ Image Slider -->
                <div class="swiper house1-slider mb-5">
                    <div class="swiper-wrapper">
                        @foreach(range(1, 4) as $i)
                            <div class="swiper-slide">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#imageModal" data-img="{{ asset('assets/img/house/house1/image'.$i.'.jpg') }}">
                                    <img src="{{ asset('assets/img/house/house1/image'.$i.'.jpg') }}" class="img-fluid rounded house-img" alt="House Image {{ $i }}">
                                </a>
                            </div>
                        @endforeach
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <ul class="list-unstyled amenities-list">
                                    ...
                                    <li>❄️ Aircond in each room</li>
                                </ul>
                                </div>
                                <div class="col-sm-6">
                                <ul class="list-unstyled amenities-list">
                                    <li>🚿 2 Private Bathroom</li>
                                    <li>🍳 Kitchen Space & Equipment</li>
                                    <li>🚗 2 Free Parking</li>
                    ...
                    <div class="modal-content">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value="DzuLyna Homestay 1 - Teluk Intan" readonly>
                                        </div>
                                        <div class="mb-3">
                        ...
                        <div class="modal-footer">
                            <form id="confirmBookingForm" method="POST" action="{{ route('booking.store') }}">
                                ...
                                <input type="hidden" name="homestay" value="1">
